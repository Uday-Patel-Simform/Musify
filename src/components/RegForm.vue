<template>
    ...
    <vee-form :validation-schema="schema" @submit="register" :initial-values="user_data">
        <!-- Name -->
        <div class="mb-3">
...
export default {
    data() {
        return {
            schema: {
                ...
                country: "required|country_excluded:Turkiye",
                tos: "tos",
            },
            user_data: {
                country: "USA",
    ...
    methods: {
        ...
        async register(values) {
            ...
            try {
                await this.create_user(values)
            } catch (e) {
                this.reg_in_submission = false;
                this.reg_alert_variant = "bg-red-500";
                this.reg_alert_msg =
                    "An unexpected error has occurred!! Please try again letter."
                return
            }

            this.reg_alert_variant = "bg-green-500";
            this.reg_alert_msg = "Congratulations! Your account hs been created.";
